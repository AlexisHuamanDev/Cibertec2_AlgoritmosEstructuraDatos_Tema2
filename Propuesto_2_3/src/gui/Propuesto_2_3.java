...
public class Propuesto_2_3 extends JFrame implements ActionListener {
			...
			if (nombre.length() > 0)
				try {
					...
					try {
						...
						e.setCelular(999888777);
						e.setSueldoSoles(e.getSueldoSoles()+200);
						listado(e);
	...
	private void listado(Empleado e) {
			imprimir("Direccion de memoria : " +e);
			imprimir("Codigo del Empleado: "+ e.getCodigo());
			imprimir("Nombre del empleado: "+e.getNomnbre());
			imprimir("Numero del celular: " +e.getCelular());
			imprimir("Sueldo en soles: "+e.getSueldoSoles());
			imprimir(""+e.sueldo());
			imprimir("");
